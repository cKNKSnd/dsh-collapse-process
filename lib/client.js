window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const STYLE_CSS_TAG = 'dsh-collapse-process/process.css';
    ...
    function apply(ctx) {
      ...
      function styleEl() {
        return document.querySelector('style[data-plugin-css=' + JSON.stringify(STYLE_CSS_TAG) + ']');
      }
      function applyCss() {
        ...
        if (hidden) {
          ...
          tag.dataset.pluginCss = STYLE_CSS_TAG;
